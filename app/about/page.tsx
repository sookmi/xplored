...
export default function AboutPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <h1 className="text-4xl font-bold text-default-primary mb-8">About</h1>

      <div className="max-w-none">
        <p className="text-lg text-default-secondary leading-relaxed mb-8">
          아이디어는 많지만, 그것을 결과물로 만드는 과정은 고독합니다.
          사수 없는 환경에서 모든 결정을 스스로 내려야 하는 솔로 디자이너와 창업가형 디자이너를 위해,
          <strong className="text-default-primary font-semibold"> 엑스플로디는 정교하게 정제된 실무 항로를 제안합니다.</strong>
        </p>

        <div className="bg-default-secondary p-6 rounded-xl border border-default-tertiary my-8">
          <h3 className="text-lg font-bold text-default-primary mb-2">All Systems Nominal.</h3>
        ...
        <h2 className="text-2xl font-bold text-default-primary mt-10 mb-4">
        ...
        <hr className="my-10 border-default-tertiary" />
